...
/**
 * Activity for managing a personal Mishna Yomit notebook.
 * Supports saving notes locally and in Firebase, loading, and deleting.
 */
public class MishnaYomitNotebookActivity extends AppCompatActivity {
        ...
        userRef.setValue(noteText)
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(MishnaYomitNotebookActivity.this, "שמירה נכשלה!", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void loadNoteFromCloud() {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(MishnaYomitNotebookActivity.this, "טעינה נכשלה!", Toast.LENGTH_SHORT).show();
            }
        });
    }
