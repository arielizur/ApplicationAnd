    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                startActivity(new Intent(MishnaYomitNoatebook.this, MainActivity.class));
            }
        });
        ...
        buttonSaveNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MishnaYomitNoatebook.this, "ההערה נשמרה!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        buttonSaveToCloud.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)  {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(MishnaYomitNoatebook.this, "גיבוי נשמר!", Toast.LENGTH_SHORT).show();
                } else {
        ...
        buttonDelet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MishnaYomitNoatebook.this, "ההערה נמחקה!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}